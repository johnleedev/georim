        ...
        <div className="maincover">
          ...
          <div className="cover ver_cover2">
            <div className="textbox box1">
              ...
              <div className="text text2">국가적 위기 극복에 항상 함께하며 복지 사각지대의 취약계층을 위한 정기적인 지원 사업 및 국내·외 봉사활동을 실시하고 있습니다.</div>
            </div>
            <div className="textbox box2">
              <div className="text text1">후원 활동</div>
              <div className="text text2">빈곤과 질병으로 고통받는 아동과 청소년들을 위해 다양한 사회복지 재단을 후원하며 아동 권리 옹호 활동을 이어가고 있습니다.</div>
            </div>
