        ...
        <div className="maincover">
          ...
          <div className="cover ver_cover2">
            <div className="textbox box1">
              ...
              <div className="text text2">창의적이고 도덕적인 인재를 육성하고 더불어</div>
              <div className="text text2">리더십과 전문성을 강화하기 위해 아낌없이 지원합니다.</div>
            </div>
            <div className="textbox box2">
              <div className="text text1">직무 전환 기회</div>
              <div className="text text2">임직원에게 직무 전환의 기회와 교육을 제공하여</div>
              <div className="text text2">조직과 개인이 모두 윈윈(win-win)하는 효과를 추구합니다.</div>
            </div>
            <div className="textbox box3">
              <div className="text text1">역량 개발 및 직무 교육</div>
              <div className="text text2">부동산 관련 다양한 교육 및 지원을 통해 기본 지식과</div>
              <div className="text text2">비즈니스 감각을 키우며 전문가로 성장할 수 있는 기회를 제공합니다.</div>
            </div>
          </div>
          </motion.div>
