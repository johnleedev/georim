        ...
        <div className="maincover">
          ...
          <div className="cover ver_cover2">
            <div className="textbox box1">
              ...
              <div className="text text2">직무와 직급에 따라 차별이 발생하지 않도록</div>
              <div className="text text2">수평적으로 소통하며 서로 신뢰하는 문화를 추구합니다.</div>
            </div>
            <div className="textbox box2">
              <div className="text text1">일과 삶의 균형</div>
              <div className="text text2">직무별 특성을 고려한 유연하고 효율적인 근무 제도를</div>
              <div className="text text2">지속적으로 확대 도입하여 개인의 상황에 따라 탄력적으로 운영합니다.</div>
            </div>
            <div className="textbox box3">
              <div className="text text1">지속적인 개선</div>
              <div className="text text2">임직원 인터뷰 및 설문 등을 통해 문제점을 파악하고</div>
              <div className="text text2">함께 조직문화 개선안을 마련하고 지속적으로 지원합니다.</div>
            </div>
          </div>
          </motion.div>
        </div>
